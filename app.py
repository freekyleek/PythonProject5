...
if __name__ == '__main__':
    with app.app_context():
        ensure_superadmin()
    for p, init in [(OPERATERI_JSON_PATH, []),(KLJENTI_JSON_PATH, []),(NALOZI_JSON_PATH, []),(AKTIVNI_UREDJAJI_JSON_PATH, []),(AKTIVNI_SIM_JSON_PATH, [])]:
